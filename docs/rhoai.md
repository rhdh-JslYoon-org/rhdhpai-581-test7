...
2) Go to the `Data Science Projects` section and access your application's project named `rhdhpai-581-test7`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rhdhpai-581-test7-notebook`.
...
5) In the terminal, run `cd rhdhpai-581-test7` to navigate to your sample app's directory.
