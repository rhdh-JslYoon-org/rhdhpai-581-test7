...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/rhdhpai-581-test7](https://github.com/rhdh-JslYoon-org/rhdhpai-581-test7)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/rhdhpai-581-test7-gitops](https://github.com/rhdh-JslYoon-org/rhdhpai-581-test7-gitops)

# **Usage**

To access the rhdhpai-581-test7 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of rhdhpai-581-test7. You can access this namespace through the web console or via your CLI.
